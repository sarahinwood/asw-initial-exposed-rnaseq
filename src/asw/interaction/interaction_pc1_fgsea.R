...
res_group <- fread("output/deseq2/asw/location_exposure_pc1_int/res_group.csv")
...
fwrite(annot_sig_fgsea, "output/deseq2/asw/location_exposure_pc1_int/sig_GO_enrichment.csv")
