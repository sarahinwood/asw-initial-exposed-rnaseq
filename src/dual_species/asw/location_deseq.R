...
fwrite(sig_annots, "output/deseq2/asw_dual/location_pairwise/sig_w_annots.csv")

plotCounts(asw_dds_location, "ASW_TRINITY_DN8325_c0_g2", intgroup = c("location"), main="")
